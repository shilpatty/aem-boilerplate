...
function buildStaticNewsletterForm(block) {
  ...
  form.innerHTML = `
    <div class="form-newsletter-row">
      <div class="form-newsletter-field">
        ...
        <input type="text" id="newsletter-fname" name="firstName" placeholder="First name" required>
      </div>
      <div class="form-newsletter-field">
        <label for="newsletter-lname">Last name *</label>
        <input type="text" id="newsletter-lname" name="lastName" placeholder="Last name" required>
      </div>
    </div>
    <div class="form-newsletter-row">
      <div class="form-newsletter-field form-newsletter-field-email">
        <label for="newsletter-email">Email Address *</label>
        <input type="email" id="newsletter-email" name="email" placeholder="Email Address" required>
      </div>
      <div class="form-newsletter-field form-newsletter-field-submit">
...
export default async function decorate(block) {
  ...
  } else if (!formDef && block.querySelector('h3')) {
    buildStaticNewsletterForm(block);
  }
}
